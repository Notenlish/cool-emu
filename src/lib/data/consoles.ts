...
export const supportedConsoles: { alternativeId: string, id: string, name: string, playUrl: string, description: string, imgUrl: SvgComponent | string, color: string, cssClass: string }[] = [
    ...
    { alternativeId: "playstation-portable", id: "playstation-portable", name: "Playstation Portable (PSP)", playUrl: "/play/psp", description: "playstation portable.", imgUrl: Controller4, color: "oklch(68.5% 0.169 237.323)", cssClass: "col-span-3 row-span-1 row-start-3 col-start-2" },
