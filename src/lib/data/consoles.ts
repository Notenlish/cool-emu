...
export const supportedConsoles: { id:string, name: string, playUrl: string, description: string, imgUrl: SvgComponent, color: string, cssClass: string }[] = [
    { id:"nes", name: "NES", playUrl: "/play/nes", description: "a.", imgUrl: Controller1, color: "oklch(58.6% 0.253 17.585)", cssClass: "col-span-2" },
